    ...
    <nav class="top-nav">
        <div class="container">
            <div class="nav-wrapper">
                ...
                <a class="help-icon right" href="javascript:void(0)"><i class="material-icons">help_outline</i></a>
                <a class="page-title right">| OCR4all</a>
                <a class="project-name right">
                ...
                <c:when test="${not empty processModals}">
                    ...
                    <div id="modal_version_warning" class="modal">
                        <div class="modal-content ">
                            ...
                            <p>
                                For efficient data processing OCR4all combines various components. Due to necessary
                                updates of our OCR engine Calamari, models trained with earlier OCR4all versions will
                                not work with this new version. Please note that, in all likelihood, this will be a
                                one-time issue and will not be the case for future updates.
                            </p>
                            <p>
                                The standard <a href="https://github.com/Calamari-OCR/calamari_models" target="_blank">mixed
                                model ensembles</a> have already been retrained. Your self-trained models will have to
                                be retrained using the "Training" submodule and your current Ground Truth (as well as an
                                optional updated default model for "Pretraining").
                            </p>
                            <p>
                                If you need to retrain many models with extensive amounts of GT, thereby overstressing
                                your own hardware, we are happy to help you out.
                                Please do not hesitate to contact us <a href="mailto:ocr4all@uni-wuerzburg.de">ocr4all@uni-wuerzburg.de</a>
